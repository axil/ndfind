...
def test2():
    ...
    assert first_above(a, 4.) == 3
    assert first_above(a, 9.) == -1
    assert first_above(a, 5.) == 3
    assert first_above(a, 10.) == -1
...
def test4():
    ...
    assert first_above(a, 4., sorted=True) == 3
    assert first_above(a, 9., sorted=True) == -1
    assert first_above(a, 5., sorted=True) == 3
    assert first_above(a, 10., sorted=True) == -1
